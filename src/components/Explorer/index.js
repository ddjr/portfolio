  ...
  return (
    <div className='explorer'>
      ...
      <div className='explorer__portfolio'>
        <div className='explorer__portfolio__header' onClick={handleToggle}>
          <ArrowForwardIosIcon className={hidden ? "rotate__back arrow" : " rotate arrow" }/>
          <h4>PORTFOLIO</h4>
        </div>
        <div className={hidden ? "hidden explorer__portfolio__dropdown " : 'explorer__portfolio__dropdown'} >
          <div className='explorer__portfolio__dropdown__item'>
          <a href="#home">
